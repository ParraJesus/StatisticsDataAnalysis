  ...
  return (
    <div className={`${styles.content}`}>
      ...
      <p>
        ...
        z-score for each value. Any data points with an absolute z-score
        (|z-score|) greater than or equal to 3 are considered outliers and are
        removed. This process repeats iteratively until no more outliers remain.
        <br /> <br />
